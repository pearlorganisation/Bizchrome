...

                            {
                                [`Candidate`, `Business`, `Investor`]?.map(item => {
                                    return <div className="relative flex w-56 items-center justify-center rounded-xl bg-gray-50 px-4 py-2 font-medium text-gray-700">
                                        ...
                                        <label className={`peer-checked:border-indigo-400 peer-checked:bg-indigo-200 peer-checked:ring-4 ring-indigo-500/30 absolute top-0 h-full w-full cursor-pointer rounded-xl border ${errors.role ? 'ring-4 ring-red-500/30' : null} `} for={`${item}`}> </label>
                                        ...
                                        <span className="pointer-events-none z-10 pl-1">{item}</span>
                                    </div>
                                })
                            }
                        </div>
