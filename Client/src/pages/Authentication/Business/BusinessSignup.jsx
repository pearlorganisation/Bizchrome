...
import bussinesLogin from "../../../assets/Images/bussiness.jpg"
...
const BusinessSignup = () => {
  ...
  <img src={bussinesLogin} alt="Placeholder Image" className="object-cover w-full h-full" />
</div>
    {/* <!-- Right Pane --> */}
    <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
      <div className="max-w-md w-full p-6">
        <h1 className="text-3xl font-semibold mb-6 text-black text-center">Sign Up AS Business</h1>
        ...
        <form action="#" method="POST" className="space-y-4">
          ...
          <div>
            <button type="submit" className="w-full bg-[#0EA89B] text-white p-2 rounded-md hover:bg-gray-800 focus:outline-none focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Sign Up</button>
          </div>
        </form>
        <div className="mt-4 text-sm text-gray-600 text-center">
          <p>Already have an account? <Link  to="/Business-login" className="text-black hover:underline">Login here</Link>
          </p>
        </div>
      </div>
    </div>
