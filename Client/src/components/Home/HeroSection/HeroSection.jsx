    ...
    <section className="bg-[#F1F1F2] min-h-dvh relative z-10">
      <div className="max-w-screen-xl mx-auto py-24 space-y-6">
        <div className="space-y-4">
          ...
          <h1 className="text-2xl md:text-4xl lg:text-6xl font-medium w-[70%] text-left">Embrace The BizChrome Work Revolution!</h1>
        ...
        <div className="grid grid-cols-[25rem_20rem_auto] bg-white rounded-md  w-fit px-3 py-2 shadow-md">
          <div className="flex justify-start items-center gap-3 px-3 border-r-[3px] w-full"><IoSearch className="text-gray-400" size={30} /><input className="w-full h-full focus: outline-none bg-transparent" type="text" name="" id="" placeholder="Search Jobs By Name" /></div>
          <div className="flex justify-start items-center gap-3 px-3 w-full"><HiOutlineLocationMarker className="text-gray-400" size={30} /><input className="w-full h-full focus: outline-none bg-transparent" type="text" name="" id="" placeholder="Search Jobs By City" /></div>
