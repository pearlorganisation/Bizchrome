      ...
      {!isApplying ? (
        <>
          <div className="w-full h-10 mb-2 px-2 flex justify-center">
            {successMsg?.length > 0 && (
              <div className="text-green-600 text-xl">{successMsg}</div>
            )}
          </div>
              ...
              <div className="md:space-y-[16px] p-4 flex flex-col justify-evenly gap-2 border rounded-lg shadow-md cursor-pointer">
                ...
                {data?.jobHighlights?.length > 0 && (
                  <>
                    <div className="rounded-lg border border-solid border-[#C1DBFB] bg-[#F5F9FE] p-[16px] flex flex-col gap-2 px-4">
                      <span className="pl-1 font-bold text-lg">
                        Job highlights
                      </span>
                      {data?.jobHighlights?.map((item) => (
                        <span className="flex gap-4">
                          {/* <icon className="w-3">🔥</icon> */}
                          <p className="m-0 text-base md:text-md">{item}</p>
                        </span>
                      ))}
                      {/* <span className="flex gap-4">
                <icon className="w-3">💼</icon>
                      ...
                      <div className="flex w-full space-x-[8px]">
                        ...
                        <div>
                          ...
                          <p className="m-0 text-sm leading-[20px] text-[#190A28] md:text-md md:leading-[24px]">
                            {data?.jobRequirements?.experience}+ Years
                          </p>
                        </div>
                      </div>
                      <div className="flex w-full space-x-[8px]">
                        ...
                        <div>
                          ...
                          <p className="m-0 text-sm leading-[20px] text-[#190A28] md:text-md md:leading-[24px]">
                            {data?.jobRequirements?.education}
                          </p>
                        </div>
                      </div>
                      <div className="flex w-full space-x-[8px]">
                        ...
                        <div>
                          ...
                          <p className="m-0 text-sm leading-[20px] text-[#190A28] md:text-md md:leading-[24px]">
                            {data?.jobRequirements?.communicationLevel}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="mb-[8px] bg-white p-[16px] md:py-0">
                  <div>
                    ...
                    <div className="grid grid-cols-1 gap-[12px] md:grid-cols-2">
                      {data?.jobRole?.department?.length > 0 && (
                        <div className="flex w-full space-x-[8px]">
                          <div className="mt-[2px] md:mt-[3px]">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                          ...
                          <div>
                            ...
                            <p className="m-0 text-sm leading-[20px] text-[#190A28] md:text-md md:leading-[24px]">
                              {data?.jobRole?.department}
                            </p>
                          </div>
                        </div>
                      )}

                      {data?.jobRole?.employmentType?.length > 0 && (
                        <div className="flex w-full space-x-[8px]">
                          <div className="mt-[2px] md:mt-[3px]">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                          ...
                          <div>
                            ...
                            <p className="m-0 text-sm leading-[20px] text-[#190A28] md:text-md md:leading-[24px]">
                              {data?.jobRole?.employmentType}
                            </p>
                          </div>
                        </div>
                      )}
                      {data?.jobRole?.category?.length > 0 && (
                        <div className="flex w-full space-x-[8px]">
                          <div className="mt-[2px] md:mt-[3px]">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                          ...
                          <div>
                            ...
                            <p className="m-0 text-sm leading-[20px] text-[#190A28] md:text-md md:leading-[24px]">
                              {data?.jobRole?.category}
                            </p>
                          </div>
                        </div>
                      )}

                      {data?.jobRole?.shift?.length > 0 && (
                        <div className="flex w-full space-x-[8px]">
                          <div className="mt-[2px] md:mt-[3px]">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="flex flex-col gap-[12px]">
                      ...
                      <div className="flex w-full space-x-[8px]">
                        ...
                        <div>
                          ...
                          <p className="m-0 text-sm leading-[20px] text-[#190A28] md:text-md md:leading-[24px]">
                            {data?.interviewDetails?.interviewMode}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                {/* Posted by */}
                <div className="bg-white p-[16px] rounded-lg border border-solid border-[#e6e6e6]">
                  <p className="md:font-md m-0 text-sm text-[#8C8594] md:text-md md:leading-[24px]">
                    Job posted by{" "}
                    <span className="font-semibold text-[#190A28]">
                      {data?.company}
                    </span>
                  </p>
                </div>
