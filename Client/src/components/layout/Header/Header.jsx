        ...
        <div className="items-center gap-x-14 px-4 max-w-screen-xl mx-auto md:flex md:px-8">
          ...
          >
            <div className=" flex justify-between">
              ...
              {
                isUserLoggedIn ? <div className="relative group  "> <img className="h-8 cursor-pointer ring-4 ring-green-600/60 border-2 border-white w-8 rounded-full object-cover" src="https://componentland.com/images/y9s3xOJV6rnQPKIrdPYJy.png" alt="Simon Lewis" />
                  <div className="mx-2 before:content-[''] before:h-[2rem] before:w-[2rem] before:bg-white before:border-t before:border-l  before:absolute before:top-[-1rem] before:left-[4rem] before:rounded-sm before:rotate-45 absolute top-[1.3rem] left-[-4rem] opacity-0 z-0 transition-all  group-hover:z-30 group-hover:opacity-100  my-10 rounded-xl border bg-white px-4 shadow-md sm:mx-auto sm:max-w-xl sm:px-8">
                    <div className="mb-2 flex flex-col gap-y-6 border-b py-8 sm:flex-row sm:items-center sm:justify-between">
                      <div className="flex items-center">
                        <img className="h-14 w-14 rounded-full object-cover" src="https://componentland.com/images/y9s3xOJV6rnQPKIrdPYJy.png" alt="Simon Lewis" />
                        <div className="ml-4 w-56">
                          <p className="text-slate-800 text-xl font-extrabold">{userMetaData?.fullName}</p>
                          <p className="text-slate-500">{userMetaData?.email}</p>
                        </div>
                      </div>
                    ...
                    <div className="flex justify-between py-8">
                      ...
                      <button onClick={() => {
                        dispatch(userLogout())
                      }} className="rounded-lg border-2 border-transparent bg-blue-600 px-4 py-2 font-medium text-white focus:outline-none focus:ring hover:bg-blue-700">Logout</button>
                    </div>
                  </div>
...

{
  /* <div className="hidden lg:block">
          <button
            type="button"
            className="rounded-md bg-[#3ACABE] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#27b0a5] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
